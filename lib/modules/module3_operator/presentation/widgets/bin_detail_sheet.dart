      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: widget.quickReasons.map((reason) {
              ...
              return ChoiceChip(
                label: Text(reason),
                selected: selected,
                selectedColor: OperatorTheme.accentSoft,
                backgroundColor: OperatorTheme.surface,
                checkmarkColor: OperatorTheme.accentDeep,
                labelStyle: TextStyle(
                  color: selected
                      ? OperatorTheme.accentDeep
                      : OperatorTheme.strongText,
                  fontWeight: FontWeight.w700,
                ),
                side: BorderSide(
                  color:
                      selected ? OperatorTheme.accent : OperatorTheme.hairline,
                ),
          ...
          TextField(
            ...
            minLines: 2,
            maxLines: 4,
            cursorColor: OperatorTheme.accent,
            style: const TextStyle(
              color: OperatorTheme.strongText,
              fontWeight: FontWeight.w600,
            ),
            decoration: InputDecoration(
              ...
              labelStyle: const TextStyle(color: OperatorTheme.mutedText),
              filled: true,
              fillColor: OperatorTheme.surfaceMuted,
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(14),
                borderSide: const BorderSide(color: OperatorTheme.hairline),
              ),
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(14),
                borderSide:
                    const BorderSide(color: OperatorTheme.accent, width: 1.4),
              ),
              errorBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(14),
                borderSide: const BorderSide(color: OperatorTheme.danger),
              ),
            ),
            onChanged: (_) {
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: OperatorTheme.accentDeep,
